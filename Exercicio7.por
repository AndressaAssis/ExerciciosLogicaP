programa
{
	...
	funcao inicio()
	{
		// Exercício 7 - Escreva um algoritmo que leia a velocidade de um veículo em km/h, e então calcule e exiba na tela a velocidade convertida em m/s (metros por segundo).
          ...
          escreva("Qual é a velocidade em Km/h? \n")
          leia(velocidadeKmH)
